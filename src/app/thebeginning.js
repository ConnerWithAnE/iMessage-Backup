...
var handle_1 = require("./tableControls/handle");
var databaseController_1 = require("./databaseController");
var temp = function () { return __awaiter(void 0, void 0, void 0, function () {
    var db, handle, allRows;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                db = new databaseController_1.InitializeDatabase('./chat.db');
                handle = new handle_1.HandleTable(db.getDB());
                return [4 /*yield*/, handle.getAllRowsAsMap()];
            case 1:
                allRows = _a.sent();
                console.log(allRows);
                return [2 /*return*/];
